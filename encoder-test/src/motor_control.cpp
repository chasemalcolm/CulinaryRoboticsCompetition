...
#define ARM_EXTENSION_FORWARD_PIN 35
#define ARM_EXTENSION_BACKWARD_PIN 36
...
void run_drive_motors(double leftPower, double rightPower) {
  run_motor(DRIVE_LEFT_FORWARD_PIN, DRIVE_LEFT_BACKWARD_PIN, leftPower, DRIVE_MOTOR_MAX_POWER, DRIVE_LEFT_LEDC_CHANNEL);
  run_motor(DRIVE_RIGHT_FORWARD_PIN, DRIVE_RIGHT_BACKWARD_PIN, rightPower, DRIVE_MOTOR_MAX_POWER, DRIVE_RIGHT_LEDC_CHANNEL);
}
