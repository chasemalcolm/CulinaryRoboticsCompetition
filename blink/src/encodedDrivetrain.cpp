...
double maxAbsPositioningPower = 0.5;
...
void tickDrivetrain() {
    ...
    switch (drivetrainState)
    {
        ...
        case SWING_TURN_LEFT:
            if (rightEncoderTarget - rightEncoder.position < ActivePositionToggleDistance) {
                drivetrainState = ACTIVE_POSIITONING;
        ...
        case SWING_TURN_RIGHT:
            ...
            if (leftEncoderTarget - leftEncoder.position < ActivePositionToggleDistance) {
                drivetrainState = ACTIVE_POSIITONING;
